...
### [Version 2.1.5](https://github.com/azurecurve/azrcrv-bbcode/releases/tag/v2.1.5)
 * Update plugin header for compatibility with ClasssicPress v2.
 
### [Version 2.1.4](https://github.com/azurecurve/azrcrv-bbcode/releases/tag/v2.1.4)
 * Update plugin header and readme for compatibility with ClassicPress Directory v2.
 * Update Update Manager to version 2.5.0.

### [Version 2.1.3](https://github.com/azurecurve/azrcrv-bbcode/releases/tag/v2.1.3)
 * Update readme file for compatibility with ClassicPress Directory.
 
### [Version 2.1.2](https://github.com/azurecurve/azrcrv-bbcode/releases/tag/v2.1.2)
 * Fix Update Manager View Details link (contributed by xxsimoxx).

### [Version 2.1.1](https://github.com/azurecurve/azrcrv-bbcode/releases/tag/v2.1.1)
 * Fix missing constants.
 
### [Version 2.1.0](https://github.com/azurecurve/azrcrv-bbcode/releases/tag/v2.1.0)
 * Fix incorrect update server path; **plugin will need to be manually updated if 2.0.0 or 2.0.1 was installed**.
 
### [Version 2.0.1](https://github.com/azurecurve/azrcrv-bbcode/releases/tag/v2.0.1)
 * Fix bug in namespace of Update Client.
 
### [Version 2.0.0](https://github.com/azurecurve/azrcrv-bbcode/releases/tag/v2.0.0)
