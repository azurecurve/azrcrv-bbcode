 ...
 *
 */
if (!function_exists('azrcrv_create_plugin_menu_bbc')){
	function azrcrv_create_plugin_menu_bbc(){
		azrcrv_create_plugin_menu_table_bbc();
		azrcrv_populate_plugin_menu_table_bbc();
	}
}
 ...
 *
 */
if (!function_exists('azrcrv_populate_plugin_menu_table_bbc')){
	function azrcrv_populate_plugin_menu_table_bbc(){
		global $wpdb;
 ...
 *
 */
if (!function_exists('azrcrv_create_plugin_menu_table_bbc')){
	function azrcrv_create_plugin_menu_table_bbc(){
		global $wpdb;
		$table_name = $wpdb->base_prefix.'azrcrv_plugin_menu';
